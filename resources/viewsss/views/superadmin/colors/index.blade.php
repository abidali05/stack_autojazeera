...
<div class="container">
		<div class="row d-flex justify-content-between">
			<div class="col-md-4">	<span class="pt-md-3 pagination_count" style="font-size: 18px; color: #281F48; font-weight:700;">
            ...
            <table class="table table-striped transparent-table align-middle datatable">
                ...
                <tbody>
                    ...
                    <tr>
						<td>{{$key+1}}</td>
                        <td>
                            <a class=" me-2" title="Edit" data-bs-toggle="modal" style="text-decoration:none" data-bs-target="#editcolorModal{{$color->id}}">
                                <i class="bi bi-pencil-square"></i>
                            </a>
                            <a class="primary-color-custom cancel"  data-id="{{$color->id}}"  title="Delete"  data-bs-toggle="modal" data-bs-target="#deleteModal">
                                <i class="bi bi-trash"></i>
                            </a>
                        </td>
                        <td>{{$color->name}}</td>
                        <td>
                        <input type="color" id="favcolor" name="code" value="{{$color->color_id}}" disabled>    
                    </td>
