...
<div class="container-fluid divborder mt-auto"  style="border: none !important;position: static;margin-top:auto;">
            ...
            <div class="row">
                ...
                <div class="row">
                    <div class="col-5 copyright">
                        <p class="ankere m-0" style="color:#B4B3B8">© 2025 AutoJazeera, All Rights Reserved.</p>
                    </div>
                    <div class="col-5 ms-auto copyright">
                        <p class="text-end m-0"><span class="me-3"><a class="ankere" style="color:#B4B3B8" target="_blank"
