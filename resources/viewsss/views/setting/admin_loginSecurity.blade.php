...
<div class="container">
  ...
  <div class="col-md-6 p-3">
            ...
            @endif
            <form class="border p-3 rounded" method="post" action="{{route('superadmin.change_password')}}">
                @csrf
                <div class="mb-3">
                ...
                <div class="mb-3">
                    ...
                    <input type="password" name="password" class="form-control" id="new-password" placeholder="Enter New Password">
                    @error('password')
                    <div class="alert ">{{ $message }}</div>
            ...
            <div class="profile-card">
                <div class="d-flex">
                    ...
                    <div class="profile-info">
                        <h5>{{$user->name}}</h5>
                        <p class="mb-0"><i class="bi bi-telephone-fill primary-color-custom"></i>{{$user->number}}</p>
                        <p class="mb-2"><i class="bi bi-envelope-fill primary-color-custom"></i> {{$user->email}}</p>
                    </div>
                </div>
                <hr>
