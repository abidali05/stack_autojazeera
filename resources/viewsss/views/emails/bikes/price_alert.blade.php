   ...
   <img src="{{ asset('web/images/emailbill.png') }}" alt="Logo" style="height:70px; width:100px" class="img-fluid">
        ...
        <div style="margin-top: 20px;">
            <p style="color: #1F1B2D; font-size: 12px; font-weight: 500;">
                Great News! Price Alerts Update: The following items have recently had a price drop:
            </p>
        </div>
        ...
        <div style="width: 100%; margin: 0 auto; margin-top:20px;">
            ...
            <div
                style="width:90%; display:flex; background-color:#white;border-radius:10px;    margin-right: 17px; border:1px solid black">
                <div
                 style="background: #fff; border-radius: 10px; box-shadow: 0 4px 8px rgba(0, 0, 0, 0.1); overflow: hidden; transition: 0.3s ease-in-out; width: 30%; height: 170px; text-align: center;">
                    <div>
                        ...
                        <img src="{{ $post->media[0]->file_path ?? asset('web/bikes/images/logo.svg') }}" alt="Car Image"
                ...
                <div style="padding: 10px; width:70%; ">
                    ...
                    <h5 style="font-size: 14px; color: #FD5631;margin:0px"><b>PKR
    ...
    padding-top: 2px;">
                    ...
                    <div style="display: flex; justify-content: space-between;">
                        <div
                            style="background-color:#002D690F; margin-right: 20px; color:#281F48; padding: 5px 10px; border-radius: 10px; text-align: center;">
                            <i class="bi bi-speedometer2"></i>
                            <p style="margin: 5px 0; font-size: 8px;"> {{ $post->milleage ?? 'N/A' }} KM</p>
                        </div>
                        <div
                            style="background-color:#002D690F; margin-right: 20px; color:#281F48; padding: 5px 10px; border-radius: 10px; text-align: center;">
