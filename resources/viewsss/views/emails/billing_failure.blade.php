...
<body style="font-family: 'Inter', sans-serif; margin: 0; padding: 0;">
    <div style="width: auto; margin: auto; background-color: white; border-radius: 10px; padding: 20px;">
        ...
        <div style="margin-top: 20px;">
            <p style="color: #1F1B2D; font-size: 22px; font-weight: 600;text-align:center">Credit Card Billing Failure
            </p>
        </div>
        <div style="margin-top: 20px;text-align:center">
            <img src="{{ asset('web/images/emailbill.png') }}" alt="Logo" style="height:70px; width:100px"
                class="img-fluid">
        </div>
        <div style="margin-top: 20px;">
        ...
        <div style="text-align: center; margin-top: 30px;">
            <a href="{{ url('dashboard') }}"
                style="color: white; font-size: 12px; font-weight: 500; background-color: #FD5631; padding: 10px 20px; border: none; border-radius: 25px; text-decoration: none;">UPDATE
                MY BILLING</a>
        </div>
        <div style="margin-top: 20px;">
        ...
        <div style="margin-top: 20px;">
            <p style="color: #1F1B2D; font-size: 12px; font-weight: 500;">
                If you do not settle this invoice with 14 days of the involved date, your account may be suspended.
                Please contact us immediately If you have any questions or concerns regarding this notice
            </p>
        </div>
        <div style="margin-top: 20px;">
        ...
        <div style="margin-top: 20px; border-top:1px solid #1F1B2D">
            <p style="color: #1F1B2D; font-size: 14px; font-weight: 300; text-align:center">Any questions? <span
                    style="color: #FD5631;">
