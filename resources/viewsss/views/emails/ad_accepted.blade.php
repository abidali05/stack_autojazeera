...
<body style="font-family: 'Inter', sans-serif; margin: 0; padding: 0;">
    <div style="width: auto; margin: auto;background-color: white;padding:20px; border-radius: 10px;">
        ...
        <div style="margin-top: 20px;">
            <p style="color: #1F1B2D; font-size: 12px; font-weight: 500;">
             Your ad is now approved and active in our marketplace. Here’s the link—feel free to share it on any social media platform!
            </p>
    ...
    <img src="{{ $post->image }}" alt="Car Image" 
         style="max-width: 100%;height: 180px; object-fit: contain; object-position: center; display: block; margin: 0 auto;">
                                ...
                                <div style="padding: 10px; width:70%; ">
                                    <div style="display:flex">
										<div>  <p style="margin:0px; color:white ; font-size:12px;font-weight:600">{{ $post->year ?? 'N/A' }}</p></div>
                                        <div style="    margin-left: auto; display:flex; ">
                                 @if ($post->feature_ad == 1)
                                              <span style="padding: 5px 5px; border-radius: 5px; font-size: 8px; font-weight: bold; display: flex; background-color:#BF0000; color:#fff; margin-end:5px">
    ...
    padding-top: 2px;">
                                    ...
                                    <div style="display: flex; justify-content: space-between; margin-top: 10px;">
                                        <div style="background-color:#002D690F; width:30%; margin-right: 20px; color:#281F48; padding: 5px 10px; border-radius: 5px; text-align: center; border:1px solid #002D690F">
     ...
     <div style="text-align: center; margin-top: 40px;">
            <a href="{{route('cardetail', $post->id)}}" style="color: #ffffff; font-size: 12px; font-weight: 500; background-color: #FD5631; padding: 10px 20px; border: none; border-radius: 15px; text-decoration: none;">View on AutoJazeera Marketplace</a>
        </div>
	    <div style="margin-top: 20px;">
            <p style="color: #1F1B2D; font-size: 12px; font-weight: 500;">
