                ...
                <div class="row align-items-center mb-2">
                    {{-- <div class="col-md-4 mb-md-0 mb-2">
                        <div class="input-group " style="width: 100%;">
                            <form id="dealerForm" action="" method="get" style="width: 100%;" class="d-none">
                    ...
                    <div class="col-md-12 text-end">
                        <a href="{{ url('superadmin/bike-ads/create') }}" class="btn custom-btn-nav rounded">
                            Post an Ad
                        </a>
                    </div>
                </div>
                    ...
                    <table class="table table-striped transparent-table align-middle ads-datatable">
                        ...
                        <tbody>
                            ...
                            @foreach ($bike_posts as $key => $post)
                                    ...
                                    <div class="modal-dialog">
                                        <div class="modal-content">
                                            <div class="modal-header border-0">
                                                <h5 class="modal-title" id="statusModalLabel{{ $post->id }}">Update
                                                    Post
                                                    Status</h5>
                                                ...
                                                <form method="post"
                                                    ...
                                                    <div class="mb-3 {{ $post->status != 2 ? 'd-none' : '' }}"
                                                        ...
                                                        <textarea class="form-control" name="rejected_reason" id="rejectionReason{{ $post->id }}"
                                                            placeholder="Enter reason for rejection" required>{{ $post->rejected_reason }}</textarea>
                                                    </div>
                                            </div>
                                ...
                                <script>
                                    function toggleRejectionReason(postId) {
                                        const status = document.getElementById(`bikepostStatus${postId}`).value;
                                        const reasonContainer = document.getElementById(`bikerejectionReasonContainer${postId}`);
