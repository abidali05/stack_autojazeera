...
.rectangle-border {
    ...
    border: 2px solid #FD5631; /* Makes the border solid and defines the color */
        ...
        <div class="row g-0">
            ...
            <div class="col-md-6 border-end">
               ...
               <p class="mt-4 ps-5">
                    ...
                    <a href="{{ route('register') }}" class="text-decoration-underline fw-bold " style="color:#FD5631;text-decoration">Sign up here</a>
                </p>
            </div>
...
@enderror
       {{-- <x-input-error :messages="$errors->get('email')" class="mt-2" style="color: #FD5631" />  --}}
                        <button type="submit" class="btn custom-btn-nav  rounded w-100 py-3" style="font-weight:600">Continue with Email</button>
