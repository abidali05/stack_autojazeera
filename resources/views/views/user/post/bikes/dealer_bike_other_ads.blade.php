  ...
  <style>
        ...
        <div class="row">
                    ...
                    <div class="card-body ">
                        ...
                        <div class="my-3">
                            ...
                            <p class="mb-1 "><i class="bi bi-envelope me-2 primary-color-custom"></i> <a
                                    href="mailto:saima@gmail.com" class="text-white" style="color: #281F48 !important">{{$dealer->email }}</a></p>
            ...
            <div class="col-lg-8 ps-md-4">
                <div class="d-flex justify-content-between">
                    <h3 class="pb-2" style="color: #281F48">Available Bikes <small> (<span
               ...
               <span class="pt-md-3 pagination_count" style="font-size: 18px; color: #281F48; font-weight:700 ">
				...
				<div class="row">
				<div class="col-12 d-flex justify-content-end">      @if ($posts->hasPages())
    ...
    margin-top: 6px;">
				...
				<div id="no_results_message" class=" row   pt-5 d-none">
					<div class="col-12 p-3" style="border:1px solid #281F48;border-radius:9px;">
						<div class="row">
							<div class="col-3">
						           <img src="{{ asset('web/images/noinput.svg') }}" alt="" class="img-fluid" srcset="">
								</div>
								<div class="col-9 text-start">
									<h1 style="color: #281F48">Sorry</h1>
									<p style="color: #281F48">No matches found for your search. Try adjusting your filters or expanding your criteria to explore  available cars!</p>
									<a href="{{url('/')}}" style="background-color:#281F48;color:white;padding:10px 15px;border-radius:5px;font-size:12px;">Go Back To Home</a>
								</div>
						</div>
					</div>
				</div>
                ...
                <div class="row gy-3 mb-3" id="postresultsContainer">
                    @if (count($posts) < 1)
                        <h3 class="text-center p-5" style="color: #281F48 !important">No Bikes available<h3>
                            @else
                                @foreach ($posts as $post)
                                    <div class="col-lg-12 post-item" data-condition="{{ $post->condition }}"
                                        ...
                                        <a @if (Request::is('superadmin/*')) href="{{ route('superadmin.bikedetail', $post->id) }}" @else href="{{ route('bikedetail', $post->id) }}" @endif
                                            class="text-white">
                                            <div class="wishlist-card">
                                                <div class="row"  style="background-color: white ; border:1px solid #0000001F ;border-radius:20px">
                                                    ...
                                                    <div class="col-lg-8 my-auto">
                                                        <div class="pe-lg-3 px-lg-0 pb-lg-0  p-3">
                                                            ...
                                                            <h4 style="color: #281F48 !important">{{ $post->makename }} {{ $post->modelname }}</h4>
                                                            ...
                                                            <div class="d-flex justify-content-between align-items-center">
                                                                ...
                                                                ?>
                                                                <span style="font-size:14px;color: #281F48 !important" >{{ $formattedDate }}</span>
                                                            </div>
                                                            <hr>
                                                            <div class="row">
                                                                <div class="col-4">
                                                                    <div class="text-center py-1"
																		...
																		@php
																			$formattedMileage = $post->mileage >= 1000 
																				? rtrim(number_format($post->mileage / 1000, 1), '.0') 
																				: $post->mileage;
																		@endphp
   ...
   // applyFilters(); // Ensure filters are applied after fetching cities
    ...
    <script>
        ...
        function applyFilters() {
            ...
            const modelIds = [...document.querySelectorAll('.model-filter:checked')].map(cb => cb.value.toLowerCase().trim());
