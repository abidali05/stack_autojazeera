        ...
        <div class="row">
            <div class="col-12 col-md-12 col-lg-12">
                <div class="row">
                    ...
                    <div class="col-md-9" id="chatContent" style="border-left: 1px solid rgba(255, 255, 255, 0.2);">
                        ...
                        <div class="modal-dialog modal-dialog-centered modal-lg">
                            <div class="modal-content " style="border-radius: 10px; overflow: hidden;">
                                ...
                                <div class="modal-footer justify-content-center border-0 p-0 pb-3">
                                    <a href="${imageUrl}" download class="btn btn-light px-4 py-2 " style="background-color: white; font-weight:600; color: #281F48; border-radius: 5px;">
