    ...
    <div class="container">
        <div class="row mt-lg-3 mt-3">
            <div class="col-lg-12 d-flex align-items-center">
                ...
                <h2 class="sec mb-0 primary-color-custom">Submitted Bike Leads</h2>
            </div>
        </div>
        {{-- <div class="row mt-3">
                                        ...
                                        <div class="row">
                                            <div class="col-lg-4">
                                                ...
                                                <div class="img-bg-home-2">
                                                    <a
                                                        @if (Request::is('superadmin/*')) href="{{ route('superadmin.bikedetail', $form->post->id) }}" @else href="{{ route('bikedetail', $form->post->id) }}" @endif>
                                                        <img src="{{ $form->media[0]->file_path ?? asset('web/images/Frame 2911.svg') }}"
