    ...
    <div class="container">
        <div class="row pb-md-5 pt-md-3">
            ...
            <div class="col-lg-8">
                ...
                @endif
                <form id="adForm" method="post" action="{{ url('superadmin/bike-ads/update') }}"
                    ...
                    <div class=" row mb-3  rounded" style="background-color:white;">
                        <div class="col-md-12 mb-2">
                            <div class="row">
                               <select name="dealer" class="form-control" style="line-height: 1 !important;" required disabled >
    @foreach ($users as $dealer)
        <option value="{{ $dealer->id }}" {{ $post->dealer_id == $dealer->id ? 'selected' : '' }}>
            {{ $dealer->name }}
        </option>
    @endforeach
</select>
							<input type="hidden" name="dealer" value="{{$post->dealer_id}}">
                            ...
                            <div class="row">
                                ...
                                <div class="row mb-3">
                                    <div class="col-md-6">
                                        ...
                                        <select class="form-select " style="background-color:transparent !important ; color:#281F48 !important" aria-label="Default select example" required
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <label for="model" class="form-label" style="color:white">Registered <span
                                                style="color:#FD5631">*</span></label>
                                        <select class="form-select  validate-field" style="background-color:transparent !important ; color:#281F48 !important" name="is_registered"
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <label for="condition" class="form-label" style="color:white">Condition <span
                                                style="color:#FD5631">*</span></label>
                                        <select class="form-select  validate-field" style="background-color:transparent !important ; color:#281F48 !important" name="condition"
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <label for="transmission" class="form-label" style="color:white">Transmission <span
                                                style="color:#FD5631">*</span></label>
                                        <select class="form-select  validate-field" style="background-color:transparent !important ; color:#281F48 !important" name="transmission"
                                ...
                                <div class="row mb-3">
                                    <div class="col-md-6">
                                        <label for="year" class="form-label" style="color:white">Assembly <span
                                                style="color:#FD5631">*</span></label>
                                        <select class="form-select validate-field" style="background-color:transparent !important ; color:#281F48 !important" name="assembly"
                                ...
                                <div class="row mb-3">
                                    <div class="col-md-6">
                                        <label for="bodyType" class="form-label" style="color:white">Make <span
                                                style="color:#FD5631">*</span></label>
                                        <select class="form-select validate-field" style="background-color:transparent !important ; color:#281F48 !important" name="make"
                                    ...
                                    <div class="col-md-6">
                                        <label for="model" class="form-label" style="color:white">Model <span
                                                style="color:#FD5631">*</span></label>
                                        <select class="form-select validate-field" style="background-color:transparent !important ; color:#281F48 !important" name="model"
                                            id="model"required>
                                ...
                                <div class="row mb-3">
                                    <div class="col-md-6">
                                        <label for="year" class="form-label" style="color:white">Year <span
                                                style="color:#FD5631">*</span></label>
                                        <select class="form-select  validate-field" style="background-color:transparent !important ; color:#281F48 !important" name="year"
                                            id="year"required>
                                            <option value="">Any</option>
                                ...
                                <div class="row mb-3">
                                    <div class="col-md-6">
                                        <label for="body_type" class="form-label" style="color:white">Body type
                                            <span style="color:#FD5631">*</span></label>
                                        <select class="form-select  validate-field" style="background-color:transparent !important ; color:#281F48 !important" name="body_type"
                                    ...
                                    <div class="col-md-6">
                                        <label for="fuel_type" class="form-label" style="color:white">Fuel type <span
                                                style="color:#FD5631">*</span></label>
                                        <select class="form-select validate-field" style="background-color:transparent !important ; color:#281F48 !important" name="fuel_type"
                                ...
                                <div class="row mb-3">
                                    <div class="col-md-6">
                                        <label for="fuel_capacity" class="form-label" style="color:white">Fuel capacity
                                            <span style="color:#FD5631">*</span></label>
                                        <select class="form-select validate-field" style="background-color:transparent !important ; color:#281F48 !important" name="fuel_capacity"
                                    ...
                                    <div class="col-md-6">
                                        <label for="color" class="form-label" style="color:white"> Color <span
                                                style="color:#FD5631">*</span></label>
                                        <select class="form-select validate-field" style="background-color:transparent !important ; color:#281F48 !important" name="exterior_color"
                                ...
                                <div class="row mb-3">
                                    <div class="col-md-12">
                                        <label for="description" class="form-label" style="color:white">Description
                                            <span style="color:#FD5631">*</span></label>
                                        <textarea class="form-control  validate-field" style="    line-height: 1 !important;" id="description" name="description"
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-md-6">
                                <label for="state" class="form-label" style="color:white">Province <span
                                        style="color:#FD5631">*</span></label>
                                <select id="province" style="background-color:transparent !important ; color:#281F48 !important" name="province"
                            ...
                            <div class="col-md-6">
                                <label for="city" class="form-label" style="color:white">City <span
                                        style="color:#FD5631">*</span></label>
                                <select id="city" style="background-color:transparent !important ; color:#281F48 !important" name="city"
                                    class="form-select  validate-field"required>
                            ...
                            {{-- <div class="col-md-12">
                                <label for="street_address" class="form-label" style="color:white">Street address <span
                                        style="color:#FD5631">*</span></label>
                                <textarea name="street_address" id="street_address" cols="30" rows="3" class="form-control">{{ $post->location->street_address ?? '' }}</textarea>
                                <div id="street_address-error" class="orange" style="display: none;">Street Address is
                                    required.
                                </div>
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-md-6">
                                ...
                                <input type="tel" class="form-control formcontrol" name="number" id="phoneNumber"
                                    ...
                                    required>
                                {{-- <small class="text-danger" id="phone-error" style="display:none;">Invalid format! Use
                                    +923XXXXXXXXX.</small> --}}
                                @error('number')
                                    <div class="alert ">{{ $message }}</div>
                                @enderror
            ...
            <div class="col-lg-4">
                <div class="wishlist-card">
                    ...
                    <div class="py-lg-3 px-lg-4 p-3">
                        ...
                        <h4 id="vehiclename" style="color:#281F48 !important">{{ $post->makename . ' ' . $post->modelname }}</h4>
                        ...
                        <div class="row my-3">
                            ...
                            <div class="col-md-12 d-flex justify-content-between">
                                ...
                                <span id="fuelTypevalue">{{ $post->fule_type }}</span>
                            </div>
                            <div class="col-md-12 d-flex justify-content-between">
            ...
            $("#adForm").validate({
                ...
                submitHandler: function(form) {
                    ...
                    console.log('Image count:', bikeFileArray ? bikeFileArray.length : 'undefined');
                     const existingImages = $('#previewContainer .preview-item').length;
               
                const newImages = bikeFileArray.length;
