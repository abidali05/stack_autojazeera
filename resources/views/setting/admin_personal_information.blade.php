                ...
                <div class="profile-card colorback">
                    <div class="d-flex">
                        ...
                        <div class="profile-info">
                            <h5>{{ $user->name }}</h5>
                            <p class="mb-2 text-break d-flex"><i class="bi bi-envelope-fill primary-color-custom me-2"></i>
                                {{ $user->email }}</p>
                        </div>
                    </div>
...
<hr style="border: none; height: 1px; background-color: #66666680;">
            ...
            <div class="p-3 col-md-6 ">
                <form class="p-3 rounded colorback" >
					@if ($errors->any())
                ...
                @endif
                    <div class="mb-3">
                        ...
                        <div class="input-groups">
                            <input type="text" class="form-control" style="border:1px solid #281F48; color:#281F48 !important;" name="name"
                                id="f-name" placeholder="" value="{{ $user->name }}" disabled>
                        </div>
                    </div>
                    <div class="mb-3">
                        <label for="email" class="form-label">Email</label>
                        <div class="input-groups">
                            <input type="email" class="form-control" style="border:1px solid #281F48; color:#281F48 !important;" name="email"
                                id="email" value="{{ $user->email }}" disabled>
                        </div>
                    </div>
                    <div class="text-end">
					<button type="button" class="px-5 rounded btn custom-btn-nav" data-bs-toggle="modal"
                        data-bs-target="#edit-personal-superadmin" style="background-color: white;">Edit
                    </button>
					</div>
                </form>
                    ...
                    <div class="modal-dialog modal-dialog-centered modal-lg">
                                ...
                                <form method="post" action="{{ route('superadmin.update_profile') }}" enctype="multipart/form-data">
                                    ...
                                    <div class="mb-2">
                                        <div class="px-1 py-2 text-center upload-box" style="height: 10%;"
                                            ...
                                            <span id="profile_uploadText">Click here to upload
												marketplace profile photo <br> <small> <i> This photo
													will be displayed with your ad in marketplace</i></small></span>
                                        </div>

                                        <!-- Hidden File Input -->
                                        <input type="file" id="profile_fileInput" accept="image/*" name="image"
                                            style="display: none;" onchange="handleprofile_FileUpload(event)">
                                    </div>
                                    <div class="mb-2">
                                        <label for="f-name" class="form-label">Full Name</label>
                        ...
                        <label for="password" class="form-label">Password</label>
                            ...
                            <span class="position-absolute" style="right: 10px; top: 35px; cursor: pointer;" onclick="togglePasswordVisibility('password', this)">
                                <i class="fa fa-eye" style="color: #281F48"></i>
                            </span>
            ...
            <div class="col-md-2">
				...
				// 	} else {
				// 		message.textContent = "Password must be at least 8 characters, contain letters, numbers, and a special character (@$!%*?&) ❌";
