    ...
    <div class="container py-3 py-lg-3">
        <div class="row">
            <div class="col-md-12 mb-3 d-flex align-items-center">
                ...
                <h2 class="sec mb-0 primary-color-custom">Dealership Details</h2>
            </div>
        ...
        <div class="row">
                ...
                <div class="profile-card" style="background-color:#F0F3F6">
                    <div class="d-flex">
                        ...
                        <div class="profile-info">
                            <h5 class="only">{{ $user->dealershipName ?? '' }}</h5>
                            @if ($user->number)
                    ...
                    <hr>
                    <p class="mb-2 only"><strong>Dealership Name : </strong>{{ $user->dealershipName ?? '' }}</p>
                    <hr>
            ...
            <div class="p-3 col-md-6 " style="border: 2px dotted #a9afb4; border-radius: 10px;">
                <form method="post" action="{{ route('dealership_profile') }}" enctype="multipart/form-data">
                    @csrf
                    <div class="mb-2">
                    ...
                    @if ($user->role == '1')
                        <div class="mb-2 d-none">
                            <label class="form-label">What type of seller are you?</label>
                            <div class="form-check">
                                <input class="form-check-input seller_type" type="radio" name="seller_type"
                                    id="car_dealer" value="car_dealer"
                                    {{ $user->userType == 'car_dealer' ? 'checked' : '' }}>
                                <label class="form-check-label" for="car_dealer"> Dealer</label>
                            </div>
                            <div class="form-check">
                                <input class="form-check-input seller_type" type="radio" name="seller_type"
                                    id="private_dealer" value="private_dealer"
                                    {{ $user->userType == 'private_dealer' ? 'checked' : '' }}>
                                <label class="form-check-label" for="private_dealer">Private
                                    Seller</label>
                            </div>
                        </div>
                        <div class="mb-2">
                            {{-- <div class="mb-2 "> --}}
                            <label for="dealership-name" class="form-label">Dealership Name</label>
                            <div class="input-groups" style="padding: 0px !important;">
                                <input type="text" class="form-control formcontrol" name="dealershipName"
                                    id="dealership-name" placeholder="" value="{{ $user->dealershipName }}">
                            </div>
                        </div>
                    @endif
