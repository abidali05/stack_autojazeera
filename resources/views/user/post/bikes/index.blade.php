                ...
                <tbody>
                    ...
                    @foreach ($posts as $i => $post)
                        <tr>
                            ...
                            <td>
                                @if ($post->status == 0)
                                    <a href="#"><span class="badge text-bg-danger">Inactive</span></a>
                            ...
                            <div class="modal-dialog modal-dialog-centered">
                                <div class="modal-content" style="border-radius: 10px; overflow: hidden;">
                                    <div class="modal-header "
                                        ...
                                        <h5 class="modal-title" id="statusModalLabel{{ $post->id }}"><strong> Ad Status</strong></h5>
                                    ...
                                    <div class="modal-body" style="background-color: #F0F3F6; color: #FD5631;">
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <select class="form-select" name="status" id="postStatus{{ $post->id }}"
                                                disabled>
                                        ...
                                        @if ($post->status == '2')
                                            <div class="mb-3" id="rejectionReasonContainer{{ $post->id }}">
                                                ...
                                                <textarea class="form-control" style="color:red !important ;     line-height: 1 !important;" name="rejected_reason" id="rejectionReason{{ $post->id }}"
                        ...
                        <div class="modal fade" id="deleteModal{{ $post->id }}" tabindex="-1" aria-labelledby="addDealerModalLabel"
                            aria-hidden="true">
                            <div class="modal-dialog modal-dialog-centered">
                                <div class="modal-content" style="border-radius: 10px; overflow: hidden;">
