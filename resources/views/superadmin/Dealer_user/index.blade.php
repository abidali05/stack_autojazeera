...
@section('content')
    ...
    <div class="container mt-3">
        <div class="row align-items-center mb-2">
            ...
            <div class="col-md-4 text-end">
                <button class="btn custom-btn-nav rounded roleuserid" data-role="{{ '2' }}" data-bs-toggle="modal"
                    data-bs-target="#addDealeruserModal">
                    <i class="bi bi-plus-circle"></i> Add New Dealer user
                </button>
            </div>
        </div>
        {{--   <div class="row align-items-center mb-4 ">
            <div class="col-md-4 mb-md-0 mb-2 ">
                <form id="dealerForm" action="" method="get">
                    <select class="form-select  select-search formselect" name="post_id" style="color:black !important"
                        aria-label="Search Dealer" aria-describedby="search-addon" id="lead-type">
                        <option selected>Select Dealer User</option>
                        <option value="0">Dealer 1</option>
            ...
            <div class="col-md-8 text-end d-none">
                <button class="btn custom-btn-nav rounded roleuserid" data-role="{{ '2' }}" data-bs-toggle="modal"
                    data-bs-target="#addDealeruserModal">
                    <i class="bi bi-plus-circle"></i> Add New Dealer user
                </button>
        ...
        <div class="row">
            <table class="table table-striped transparent-table align-middle dealer-user-datatable">
                ...
                <tbody>
                    ...
                    <tr colspan="12" class="text-center my-5">
                        <td></td>
                        <td></td>
                        <td></td>
                        <td>You haven't created any users yet</td>    
                        </a></td>
                        <td></td>
                        <td></td>
