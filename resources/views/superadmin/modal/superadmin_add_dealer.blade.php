...
<div class="modal fade" id="superadmin_add_dealerModal" tabindex="-1" aria-labelledby="addDealerModalLabel"
    aria-hidden="true">
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            <div class="border-0 modal-header"
                ...
                <h5 class="modal-title" id="newsletterresponseLabel"> <strong> Add New Dealer </strong></h5>
                <button type="button" class="btn-close" style="background-color: #D9D9D9 !important; color: #FD5631;"
                    data-bs-dismiss="modal" aria-label="Close"></button>
            </div>
            <form id="superadmin_add_userForm" method="post" action="{{ route('superadmin.dealerStore') }}"
...
<script>
    document.addEventListener("DOMContentLoaded", function() {
        const provinceSelect = document.getElementById('province11');
        const citySelect = document.getElementById('city11');

        if (provinceSelect) {
            provinceSelect.addEventListener('change', function() {
                const provinceId = this.value;

                // Always reset cities to default option
...
//     document.addEventListener('DOMContentLoaded', function () {
//     const dealershipSelect = document.getElementById('dealershipName');

//     dealershipSelect.addEventListener('invalid', function (e) {
//         e.preventDefault(); // stop the browser's default invalid focus
//         const modal = bootstrap.Modal.getOrCreateInstance(
//             document.getElementById('superadmin_add_dealerModal')
//         );
//         modal.show();

//         // Delay focus until modal is fully open
//         setTimeout(() => dealershipSelect.focus(), 300);
//     });
// });

// document.getElementById('superadmin_add_userForm').addEventListener('submit', function (e) {
//     const dealershipSelect = document.getElementById('dealershipName');
//     if (!dealershipSelect.value.trim()) {
//         e.preventDefault();
//         const modal = bootstrap.Modal.getOrCreateInstance(
//             document.getElementById('superadmin_add_dealerModal')
//         );
