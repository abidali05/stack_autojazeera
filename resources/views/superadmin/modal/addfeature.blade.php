    ...
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content" style="border-radius: 10px; overflow: hidden;">
            <div class="modal-header border-0" style="background-color: #D9D9D9 !important; color: #281F48; border-bottom: none;">
                <h5 class="modal-title" id="featureModalLabel"> <strong>Add Feature</strong></h5>
            ...
            <div class="modal-body" style="background-color: #F0F3F6; color: #FD5631;">
                <form id="featureForm" method="post" action="{{route('superadmin.feature.store')}}" enctype="multipart/form-data">
                    @csrf
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            <div class="mb-3">
                                ...
                                <select class="form-select" name="featureType" style="color:#281F48;background-color:white" id="featureType" required>
                            ...
                            <div class="mb-3">
                                ...
                                <input type="text" name="featureName" class="form-control" id="bodyType" placeholder="Enter Feature Name"
                                    required>
                            </div>
