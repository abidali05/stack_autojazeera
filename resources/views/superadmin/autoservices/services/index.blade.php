                        ...
                        <tr>
                            ...
                            <td>
                                <a class=" me-2" title="Edit" data-bs-toggle="modal" style="text-decoration: none"
                                    data-bs-target="#editServiceCategoryModal{{ $service->id }}">
                                    <i class="bi bi-pencil-square"></i>
                                </a>
                                <a class="primary-color-custom cancel" data-id="{{ $service->id }}" title="Delete"
                                    data-bs-toggle="modal" data-bs-target="#deleteServiceCategoryModal{{ $service->id }}">
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-md-6 text-center">
                                                    <div class="upload-area border border-dashed rounded p-4 text-center"
                                                        onclick="document.getElementById('categoryiconupload{{ $service->id }}').click();">
                                                        <p class="mb-0">Click here to upload Icon</p>
                                                        <input type="file" id="categoryiconupload{{ $service->id }}"
                                                            name="icon" class="d-none"
                                                            accept=".png, .jpg, .jpeg, .gif, .ico, .svg"
                                                            onchange="handleServiceCategoryIconUpload(this, 'categoryiconpreview{{ $service->id }}')">
                                                    </div>
