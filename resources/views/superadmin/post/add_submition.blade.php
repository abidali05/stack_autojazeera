...
<style>
    ...
    .addheading{
        font-size: 35px;font-weight: 700;color: #FD5631;
    }
    .buttonback{
    ...
    <a href="{{ route('superadmin.home') }}" class="buttonback">Go Back To Home</a>
@else
...
@endif
                ...
                <p class="white">Ad Submission Confirmation <br>
                    Thank you for submitting your ad! We’ve received it, and our team will review it shortly. We aim to ensure every ad meets our community guidelines and marketplace standards</p>
            <p class="orange">What to Expect Next:</p>
                    <ul class="white">
                <li>Approval: If everything checks out, your ad will be approved, and you’ll be notified via email. Your ad will then go live on the marketplace, ready to reach potential buyers!</li>
            <li>Rejection: If your ad doesn’t meet our guidelines, don’t worry! We’ll send you an email detailing the necessary changes. Once you make those adjustments, you can easily resubmit your ad for review.</li>
            </ul>
