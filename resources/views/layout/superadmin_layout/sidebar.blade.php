...
#sidebar::-webkit-scrollbar-track {
    background: #F4F4F4; /* Red background for the track */
}

#sidebar::-webkit-scrollbar-thumb {
    background-color:  #281F48; /* Green scroll thumb */
    border-radius: 4px;
}

#sidebar::-webkit-scrollbar-thumb:hover {
    background-color:  #281F48; /* Optional: darker green on hover */
}
 ...
 <div id="sidebar">
     ...
     <div class="collapse ps-3" id="postAnAdMenu">
         <a class="nav-link" href="{{ url('superadmin/ads/create') }}"> <span class="d-flex align-items-center">  <img src="{{ asset('web/images/car1.svg') }}"                         style="height:20px !important ; width:20px !important; " class="me-2" alt="...">Car</span></a>
     ...
     <div class="collapse ps-3" id="manageAdMenu">
         <a class="nav-link" href="{{ url('superadmin/ads') }}"> <span class="d-flex align-items-center">  <img src="{{ asset('web/images/car1.svg') }}"                         style="height:20px !important ; width:20px !important; " class="me-2" alt="...">Car</span></a>
     ...
     {{-- <a class="nav-link d-flex  align-items-center" data-bs-toggle="collapse" href="#Users" role="button"
     ...
     <!-- Collapsed Menu -->
     <div class="collapse ps-3" id="Users">
         <a class="nav-link" href="{{ url('superadmin/dealer') }}"> <span class="d-flex align-items-center"><img
