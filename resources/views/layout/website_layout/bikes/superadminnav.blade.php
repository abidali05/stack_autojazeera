...
<nav class="navbar navbar-expand-lg navbar-light"
    style="background-color: white; box-shadow:0px 4px 10px 0px rgba (0,0,0,0.25);">
    <div class="container">
        <!-- Logo -->
        <a class="navbar-brand" href="{{ route('superadmin.dashboard') }}">
            <img src="{{ asset('web/images/Final Logo.svg') }}" alt="Logo" style="height:55px; width:180px"
                class="img-fluid">
        </a>
        ...
        <div class="collapse navbar-collapse" id="navbarNav">
            <ul class="navbar-nav mx-auto align-items-center ">
                ...
                <li class="nav-item m-0 {{ Request::is('all-blogs') ? 'active' : '' }}">
                    <a href="{{ route('all-blogs') }}" class="nav-link"
                        style="{{ Request::is('all-blogs') ? 'color: #F40000; font-weight: bold;' : '' }}">
                        Blogs
                    </a>
                </li>
            ...
            <div class="d-flex align-items-center justify-content-center">
                ...
                <div class="dropdown">
                    <img class="dropdown-toggle" type="button" id="profileDropdown" data-bs-toggle="dropdown"
                        aria-expanded="false" src="{{ asset('web/images/Group 2911.png') }}" alt="Bikes Icon"
                        width="100px">
                    <ul class="dropdown-menu p-0" aria-labelledby="profileDropdown">
                        <li class="dropdown-item p-0">
                            @if (Route::has('login'))
                                @auth
                                    <a class="btn border-0 w-100 p-0 px-2 py-2 text-start"
                                        href="{{ route('superadmin.dashboard') }}">My Account</a>
                            </li>
                            <li class="dropdown-item  p-0">
                                <a class="btn border-0 p-0 px-2 py-2 w-100 text-start"
                                    href="{{ route('superadmin.dealer.index') }}">Manage Dealer</a>
                            </li>
                            <li class="dropdown-item p-0">
                                <a class="btn border-0 p-0 px-2 py-2 w-100 text-start"
                                    href="{{ route('superadmin.ads.index') }}">Manage Ads</a>
                            </li>
                            <li class="dropdown-item p-0">
                                <a class="btn border-0 p-0 px-2 py-2 w-100 text-start"
                                    href="{{ route('superadmin.subscription.index') }}">Manage Subscription</a>
                            </li>
                            <li class="dropdown-item p-0">
                                <a class="btn border-0 p-0 px-2 py-2 w-100 text-start"
                                    href="{{ route('superadmin.user.index') }}">Manage User</a>
                            </li>
                            <li class="dropdown-item p-0">
                                <a class="btn border-0 p-0 px-2 py-2 w-100 text-start"
                                    href="{{ route('superadmin.color.index') }}">Manage Color</a>
                            </li>
                            <li class="dropdown-item p-0">
                                <a class="btn border-0 p-0 px-2 py-2 w-100 text-start"
                                    href="{{ route('superadmin.feature.index') }}">Manage Feature</a>
                            </li>
                            <li class="dropdown-item p-0">
                                <a class="btn border-0 p-0 px-2 py-2 w-100 text-start"
                                    href="{{ route('superadmin.make.index') }}">Manage Make</a>
                            </li>
                            <li class="dropdown-item p-0">
                                <a class="btn border-0 p-0 px-2 py-2 w-100 text-start"
                                    href="{{ route('superadmin.model.index') }}">Manage Model</a>
                            </li>
                            <li class="dropdown-item p-0">
                                <a class="btn border-0 p-0 px-2 py-2 w-100 text-start"
                                    href="{{ route('superadmin.bodytype.index') }}">Manage Bodytype</a>
                            </li>
                        @else
                            <li class="dropdown-item p-0">
                                <a class="btn w-100 text-start  border-0 p-0 py-2 ps-1 w-100 text-start"
                                    href="{{ route('superadmin.login') }}">Sign In</a>
                            </li>
                        @endauth
                        @endif
