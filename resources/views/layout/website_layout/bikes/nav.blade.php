...
<nav class="navbar navbar-expand-lg ">
    <div class="container">
        <a class="navbar-brand" href="{{ url('/') }}"><img src="{{ asset('web/bikes/images/logo.svg') }}"
                class="w-75" alt="..."></a>
            ...
            <ul class="navbar-nav ms-auto text-center align-items-center">
                <li class="nav-item m-0 {{ Request::is('/') ? 'active' : '' }}">
                    <a href="{{ url('/') }}" class="nav-link"
                        style="{{ Request::is('/') ? 'color: #F40000; font-weight: bold;' : '' }}">
                        Cars
                    </a>
                </li>
                ...
                <li class="nav-item m-0 {{ Request::is('bikes') ? 'active' : '' }}">
                    <a href="{{ url('/bikes') }}" class="nav-link"
                        style="{{ Request::is('bikes') ? 'color: #F40000; font-weight: bold;' : '' }}">
                        Bikes
                    </a>
                </li>
                ...
                <li class="nav-item m-0 {{ Request::is('services') ? 'active' : '' }}">
                    <a href="{{ url('/services') }}" class="nav-link"
                        style="{{ Request::is('services') ? 'color: #F40000; font-weight: bold;' : '' }}">
                        Auto Services
                    </a>
                </li>
                ...
                <li class="nav-item m-0 {{ Request::is('dashboard') ? 'active' : '' }}">
                    @if (Route::has('login'))
                        @auth
                            <a href="{{ Request::is('superadmin/*') ? route('superadmin.dashboard') : url('/dashboard') }}"
                                class="nav-link"
                                style="{{ Request::is('dashboard') ? 'color: #F40000; font-weight: bold;' : '' }}">
                                Dashboard
                            </a>
                        @endauth
                    @endif
            ...
            <ul class="navbar-nav ms-auto text-center align-items-center">
                ...
                <li class="nav-item">
                    <a class="nav-link " aria-current="page"
                        href="{{ Request::is('superadmin/*') ? route('superadmin.advertise') : route('advertise') }}"><button
                            class="postb">Post an ad</button></a>
                </li>
                <li class="nav-item">
                    <div class="dropdown">
                        <img class="dropdown-toggle" type="button" id="profileDropdown" data-bs-toggle="dropdown"
                            aria-expanded="false" src="{{ asset('web/images/Frame 2911.svg') }}" alt="Bikes Icon"
                            width="100px">
    ...
    <a class="btn " href="{{ route('login') }}">Sign In</a>
						...
						<li class="dropdown-item p-0"><a class="btn p-0 p-2 w-100 text-start" href="{{url('/price-alert')}}">My Price Alerts</a></li>
                                ...
                                @elseif (Auth::user()->role == '0')
                                    <li class="dropdown-item p-0"><a class="btn p-0 p-2 w-100 text-start"
                                            href="{{ url('/personal-info') }}">Personal Info</a></li>
                                    <li class="dropdown-item p-0"><a class="btn p-0 p-2 w-100 text-start"
                                            href="{{ url('/whishlist') }}">My Wishlist</a></li>
                                    <li class="dropdown-item p-0"><a class="btn p-0 p-2 w-100 text-start"
                                            href="{{ url('/price-alert') }}">My Price Alerts</a></li>

                                    <li class="dropdown-item p-0"><a class="btn p-0 p-2 w-100 text-start"
                                            href="{{ url('/submitted-forms') }}">My Submitted Forms</a></li>
                                ...
                                <li class=" ab dropdown-item py-2 d-flex justify-content-center">
                                    <span class="forhund">Sign in</span>
                                </li></a>
                                <a class="  text-center" href="{{ route('register') }}">
                                    <li class=" ab dropdown-item py-2 d-flex justify-content-center">
                                        <span class="forhund"> Sign Up</span>
                                    </li>
                                    @endif
                    </li></a>
                </ul>
