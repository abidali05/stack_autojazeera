    ...
    <div class="container">
        <div class="row pb-md-5 pt-md-3">
            <div class="col-lg-8">
                ...
                @endif
                <form id="adForm" method="post" action="{{ route('superadmin.bike-ads.store') }}" enctype="multipart/form-data">
                    @csrf
                    ...
                    <div class=" row mb-3  rounded" style="background-color:white;">
                        <div class="col-md-12 mb-2" >
                             <div class="row">
                                <select name="dealer" class="form-control" required style="     border: 1px solid #D0D5DD !important;   line-height: 1 !important;" id="dealer">
                            ...
                            <div class="row">
                                ...
                                <div class="row mb-3">
                                    <div class="col-md-6">
                                        ...
                                        <select class="form-select " aria-label="Default select example" required style="background-color: white !important ; color:#281F48 !important"
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <select class="form-select  validate-field" name="is_registered"
                                           style="background-color: white !important ; color:#281F48 !important" id="is_registered"required>
                                            <option value="">Select Option</option>
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <select class="form-select validate-field" name="condition"
                                         style="background-color: white !important ; color:#281F48 !important"   id="condition"required>
                                            <option value="">Select Option</option>
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <label for="transmission" class="form-label" style="color:white">Transmission <span
                                                style="color:#FD5631">*</span></label>
                                        <select class="form-select  validate-field" name="transmission" style="background-color: white !important ; color:#281F48 !important"
                                ...
                                <div class="row mb-3">
                                    <div class="col-md-6">
                                      ...
                                      style="background-color: white !important ; color:#281F48 !important"      id="assembly"required>
                                            <option value="">Any</option>
                                            <option value="local" {{ old('assembly') == 'local' ? 'selected' : '' }}>Local
                                            </option>
                                ...
                                <div class="row mb-3">
                                    <div class="col-md-6">
                                        ...
                                        <select class="form-select  validate-field" name="make"
                                           style="background-color: white !important ; color:#281F48 !important"  id="bike_make"required>
                                            <option value="">Any</option>
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        style="background-color: white !important ; color:#281F48 !important"    id="model"required>
                                ...
                                <div class="row mb-3">
                                    <div class="col-md-6">
                                        ...
                                        style="background-color: white !important ; color:#281F48 !important"    id="year"required>
                                            <option value="">Any</option>
                                ...
                                <div class="row mb-3">
                                    <div class="col-md-6">
                                        ...
                                        <select class="form-select  validate-field" name="body_type"
                                         style="background-color: white !important ; color:#281F48 !important"    id="body_type"required>
                                            <option value="">Any</option>
                                    ...
                                    style="background-color: white !important ; color:#281F48 !important"        id="fuel_type"required>
                                            <option value="">Any</option>
                                ...
                                <div class="row mb-3">
                                    <div class="col-md-6">
                                       ...
                                       style="background-color: white !important ; color:#281F48 !important"     id="fuel_capacity"required>
                                            <option value="">Any</option>
                                    ...
                                    <div class="col-md-6">
                                     ...
                                     style="background-color: white !important ; color:#281F48 !important"       id="exterior_color"required>
                                            <option value="">Any</option>
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-md-6">
                                ...
                                <select id="province" name="province"
                                     style="background-color: white !important ; color:#281F48 !important"    class="form-select  validate-field"required>
    ...
    $(document).ready(function() {
        ...
        $("#adForm").validate({
            rules: {
                ...
                'features[]': { requireOneFeature: true }
            },
            messages: {
                ...
                price: { required: "Please enter price", number: "Please enter a valid number", min: "Price cannot be negative" },
                make: { required: "Please select make" },
                model: { required: "Please select model" },
                year: { required: "Please select year" },
                mileage: { required: "Please enter mileage", number: "Please enter a valid number", min: "Mileage cannot be negative" },
                ...
                description: { required: "Please enter description", minlength: "Description must be at least 10 characters long" },
                province: { required: "Please select province" },
                city: { required: "Please select city" },
                street_address: { required: "Please enter street address" },
                firstName: { required: "Please enter first name", minlength: "First name must be at least 2 characters long" },
                secondName: { required: "Please enter second name", minlength: "Second name must be at least 2 characters long" },
                email: { required: "Please enter email address", email: "Please enter a valid email address" },
                number: { required: "Please enter phone number", pattern: "Please enter a valid phone number in format: +92 3XX XXXXXXX" },
                'features[]': { requireOneFeature: "Please select at least one feature" }
            },
            errorElement: 'div',
            errorClass: 'orange',
