        ...
        <div class="row align-items-center mb-4">
           {{-- <div class="col-md-4 mb-md-0 mb-2">
                ...
                <button class="btn custom-btn-nav rounded" data-bs-toggle="modal" data-bs-target="#addBodyTypeModal">
                    <span> <i class="bi bi-plus fs-5 p-0 m-0 text-white"></i></span> <span class="pb-3 text-white"> Add Body Type</span>
                </button>
            </div>
                                ...
                                <div class="modal-dialog modal-dialog-centered">
                                    <div class="modal-content" style="border-radius: 10px; overflow: hidden;">
                                        <div class="modal-header border-0" style="background-color: #D9D9D9 !important; color: #281F48; border-bottom: none;">
                                            <h5 class="modal-title" id="featureModalLabel"> <strong> Edit Body Type</strong></h5>
